                ...
                <Card>
                    ...
                    <Form className="form theme-form">
                        <CardBody>
                            ...
                            <Row>
                                <Col sm="12" xl="3">
                                    <Button color="primary" className="btn btn-air-primary" onClick={handleFetchAttendance} disabled={!selected.department || !selected.semester || !selected.subject || !selected.fromDate || viewAttendanceDisabled}>
