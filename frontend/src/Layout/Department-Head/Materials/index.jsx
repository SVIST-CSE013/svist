...
const Material = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
          try {
            const response = await axios.post(`${baseApiURL()}/getFilteredMaterial`, {department: department});
            ...
            const filteredMaterials = sortedMaterials.filter(material => material.department === department);
                                ...
                                <Table>
                                    <thead>
                                        <tr className='border-bottom-primary'>
                                            <th className='text-center' scope='col'>Material Title</th>
                                            ...
                                            <th className='text-center' scope='col'>Uploaded By</th>
                                            <th className='text-center' scope='col'>Published</th>
                                            <th className='text-center' scope='col'>View File</th>
